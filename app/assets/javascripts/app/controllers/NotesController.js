Guidebook.controller('AddNoteController', ['$scope', '$location', '$routeParams', 'NoteModel',
...
Guidebook.controller('DeleteNoteController', ['$scope', '$location', '$routeParams', 'NoteModel',
  function ($scope, $location, $routeParams, NoteModel) {
    var chapterId = $routeParams.chapterId;
